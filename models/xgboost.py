...
def build_and_train_model(max_depth, learning_rate, n_estimators):
...
def optimize_hyperparameters(trial):
    ...
    model = build_and_train_model(max_depth, learning_rate, n_estimators)
...
model = build_and_train_model(best_params['max_depth'], best_params['learning_rate'], 
