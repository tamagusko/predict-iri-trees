...
def build_and_train_model(depth, learning_rate, n_estimators):
    model = cb.CatBoostRegressor(depth=depth, learning_rate=learning_rate, n_estimators=n_estimators,
                                 random_state=42)
...
model = build_and_train_model(best_params['depth'], best_params['learning_rate'], 
